	...
	*/
	...
	function getTableList($skip_authentication = false){
		...
		$arrTables = array(
			...
			'houses' => array('Tools', '', 'resources/table_icons/building_add.png', 'None'),
			'tenants' => array('User', '', 'resources/table_icons/group_add.png', 'None'),
	...
	function htmlUserBar(){
		...
		<nav class="navbar navbar-default navbar-fixed-top hidden-print" role="navigation">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="<?php echo PREPEND_PATH; ?>index.php"><i class="glyphicon glyphicon-home"></i> POWER TOOLS RENTAL MANAGEMENT</a>
			</div>
