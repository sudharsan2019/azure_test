...
<meta charset="utf-8">
    ...
    <title>POWER TOOLS RENTAL MANAGEMENT SYSTEM</title>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#">Power Tools Rental Management</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="#"><i class="fa fa-building fa-fw"></i>Tools<span class="fa arrow"></span></a>
                        ...
                        <li>
                            <a href="tenants_view.php"><i class="fa fa-users fa-fw"></i>User</a>
                        </li>
                        <li>
