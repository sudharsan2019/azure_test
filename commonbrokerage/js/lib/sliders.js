function ion_range_slider() {
	
	var rate_appended = 0;
	
	 values_p =  [
      "1/2/2/1", "1/3/3/1", "1/4/4/1",
      "2/2/2/2", "2/3/3/2", "2/4/4/2", "end"
    ];
  limits =[
      "1221", "1331", "1441",
      "2222", "2332", "2442", "end"
  ...
  $("#inline-radios1").ionRangeSlider({
    ...
    values: limits,
    prettify: function (n) {
      var ind = limits.indexOf(n);
      return values_p[ind];
    },
    onChange: function(data) {
    global_limit_slider = data.from_value;
    trigger_ratefn();
  ...
  $("#deduct_09").ionRangeSlider({
    ...
    values: deduct,
    prettify: function (n) {
      var ind = deduct.indexOf(n);
      return deduct_p[ind];
    },
    onChange: function(data) {
    global_deduct_slider = data.from_value;
    trigger_ratefn();
  },
  });
  
function trigger_ratefn()
  {
  if(rate_appended==1){
