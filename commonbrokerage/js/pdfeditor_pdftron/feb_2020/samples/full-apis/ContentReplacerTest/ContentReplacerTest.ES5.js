                    ...
                    function(t) {
                      for (;;)
                        switch ((t.prev = t.next)) {
                          case 0:
                            return (t.prev = 0), (r = '../TestFiles/'), (e = 'BusinessCardTemplate.pdf'), (o = 'BusinessCard.pdf'), (t.next = 6), n.initialize();
                          case 6:
                            return (t.next = 8), n.PDFDoc.createFromURL(r + e);
                          case 8:
                            return (i = t.sent).initSecurityHandler(), i.lock(), (t.next = 13), n.ContentReplacer.create();
                          case 13:
                            return (u = t.sent), (t.next = 16), i.getPage(1);
                          case 16:
                            return (c = t.sent), (t.next = 19), n.Image.createFromURL(i, r + 'peppers.jpg');
                          case 19:
                            return (f = t.sent), (t.next = 22), c.getMediaBox();
                          case 22:
                            return (a = t.sent), (t.next = 25), f.getSDFObj();
                          case 25:
                            return (s = t.sent), (t.next = 28), u.addImage(a, s);
                          case 28:
                            return (t.next = 30), u.addString('NAME', 'John Smith');
                          case 30:
                            return (t.next = 32), u.addString('QUALIFICATIONS', 'Philosophy Doctor');
                          case 32:
                            return (t.next = 34), u.addString('JOB_TITLE', 'Software Developer');
                          case 34:
                            return (t.next = 36), u.addString('ADDRESS_LINE1', '#100 123 Software Rd');
                          case 36:
                            return (t.next = 38), u.addString('ADDRESS_LINE2', 'Vancouver, BC');
                          case 38:
                            return (t.next = 40), u.addString('PHONE_OFFICE', '604-730-8989');
                          case 40:
                            return (t.next = 42), u.addString('PHONE_MOBILE', '604-765-4321');
                          case 42:
                            return (t.next = 44), u.addString('EMAIL', 'info@pdftron.com');
                          case 44:
                            return (t.next = 46), u.addString('WEBSITE_URL', 'http://www.pdftron.com');
                          case 46:
                            return (t.next = 48), u.process(c);
                          case 48:
                            return (t.next = 50), i.saveMemoryBuffer(n.SDFDoc.SaveOptions.e_remove_unused);
                          case 50:
                            (l = t.sent), saveBufferAsPDFDoc(l, o), console.log('Done. Result saved in ' + o), (t.next = 58);
                            break;
                          case 55:
                            (t.prev = 55), (t.t0 = t.catch(0)), console.log(t.t0);
                          case 58:
                            return (t.prev = 58), (h = '../TestFiles/'), (p = 'newsletter.pdf'), (v = 'ContentReplaced.pdf'), (t.next = 64), n.initialize();
                          case 64:
                            return (t.next = 66), n.PDFDoc.createFromURL(h + p);
                          case 66:
                            return (y = t.sent).initSecurityHandler(), y.lock(), (t.next = 71), n.ContentReplacer.create();
                          case 71:
                            return (d = t.sent), (t.next = 74), y.getPage(1);
                          case 74:
                            return (g = t.sent), (t.next = 77), g.getMediaBox();
                          case 77:
                            return (m = t.sent), (t.next = 80), d.addText(m, 'The quick onyx goblin jumps over the lazy dwarf');
                          case 80:
                            return (t.next = 82), d.process(g);
                          case 82:
                            return (t.next = 84), y.saveMemoryBuffer(n.SDFDoc.SaveOptions.e_remove_unused);
                          case 84:
                            (b = t.sent), saveBufferAsPDFDoc(b, v), console.log('Done. Result saved in ' + v), console.log('Done.'), (t.next = 93);
                            break;
                          case 90:
                            (t.prev = 90), (t.t1 = t.catch(58)), console.log(t.t1);
                          case 93:
                          case 'end':
                            return t.stop();
                        }
