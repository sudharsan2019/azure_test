                            ...
                            function(t) {
                              for (;;)
                                switch ((t.prev = t.next)) {
                                  ...
                                  case 124:
                                    return (E = t.sent), (O = '<Line box="' + m.x1 + ', ' + m.y1 + ', ' + m.x2 + ', ' + m.y1 + '">'), (t.t5 = O), (t.next = 129), u(E);
                                  case 129:
                                    return (O = t.t5 += t.sent), (t.next = 132), d.getCurrentNum();
                                  case 132:
                                    return (F = t.sent), (O += ' cur_num="' + F + '">'), console.log(O), (P = ''), (t.next = 138), d.getFirstWord();
                                  case 138:
                                    x = t.sent;
                                  case 139:
